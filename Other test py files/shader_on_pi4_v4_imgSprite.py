...
"""
# will render at Width and height size - disregards field of view.
CAMERA = pi3d.Camera(is_3d=False, lens=(1.0, # near plane
                           1000.0, # far plane
                           70,     # field of view
                           S_RES_W / float(S_RES_H)))
"""
"""
# will render at Width and height size - disregards field of view.
CAMERA = pi3d.Camera(is_3d=False, lens=(1.0, # near plane
...
#shader = pi3d.Shader("shaders/filter_sepia")
shader = pi3d.Shader("shaders/paste_here")
#shader = pi3d.Shader("shaders/uv_flat")
#shader = pi3d.Shader("shaders/2d_flat_my")
#shader = pi3d.Shader("shaders/paste_here1")
...
#sprite = pi3d.ImageSprite(tex, shader, w=DISPLAY.height * tex.ix / tex.iy, h=DISPLAY.height, z=DISPLAY.height)
#sprite = pi3d.Sprite(flip=False,w=DISPLAY.height * tex.ix / tex.iy, h=DISPLAY.height, z=DISPLAY.height)
#sprite = pi3d.Sprite(flip=True,w=S_RES_H * tex.ix / tex.iy, h=S_RES_H, z= S_RES_H)
sprite = pi3d.Sprite(flip=True, w=S_RES_W, h=S_RES_H, z= S_RES_H)
...
# do fullscreen - but include exit condition in code before implementing
