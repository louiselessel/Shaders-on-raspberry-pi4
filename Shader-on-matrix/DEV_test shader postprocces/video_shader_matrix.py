...
W, H, P = 320,240,3 #480, 270, 3 # video width, height, bytes per pixel (3 = RGB)
...
postsh = pi3d.Shader('test_video_drost')
post = pi3d.PostProcess(camera=CAM2D, shader=postsh, scale=SCALE)
...
sprite = pi3d.Sprite(camera=CAM2D, w=DISPLAY.width, h=DISPLAY.height)
